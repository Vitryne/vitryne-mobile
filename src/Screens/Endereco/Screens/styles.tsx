...
export const styles = StyleSheet.create({
  ...
  addressTitle: { fontSize: 15, fontWeight: '600', color: colors.text },
  ...
  tagPadrao: { backgroundColor: colors.primary },
  tagAlerta: { backgroundColor: colors.danger },
  ...
  alertText: { flex: 1, fontSize: 13, color: colors.textMuted, lineHeight: 18 },
  alertHighlight: { color: colors.danger, fontWeight: '700' },
  ...
  tempoTitle: { fontSize: 15, fontWeight: '700', color: colors.text, marginBottom: spacing.sm },
  tempoRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    paddingVertical: spacing.xs,
  },
  tempoLoja: { fontSize: 14, color: colors.textMuted },
  tempoValor: { fontSize: 14, fontWeight: '600', color: colors.text },
});